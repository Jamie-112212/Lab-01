...
visitors %>% 
  summarise(
    ...
    med_2021 = median(n_2022,na.rm=TRUE)
  )
```
...
#There are values for n_2021 which are NA so when the average is calculated, it #includes these values which causes the result to be NA as you cant take the average #of data when there is no data.
...
**Write your answer here**
#There is a large outlier(s) with significantly more visitors than everything else.
